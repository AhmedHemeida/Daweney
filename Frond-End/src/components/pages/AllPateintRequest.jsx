...
import {FaSearch } from "react-icons/fa";
    ...
    export default function AllPateintRequest() {
      ...
      return (
        ...
        <div className="heading mt-4">Old Services  </div>
      ...
      />
        ...
        {/* <div className='Allrequest '>
            <p className='eve'>All Requestes</p>
            
            <p className='even'>Accepted  Requestes</p>
